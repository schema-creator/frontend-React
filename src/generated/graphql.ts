...
export type PostEditorSubscription = {
  __typename?: "Subscription";
  postEditor?: {
    __typename?: "Save";
    saveId: string;
...
export type CreateProjectMemberMutationResult =
  Apollo.MutationResult<CreateProjectMemberMutation>;
...
export type UpdateProjectMemberMutationResult =
  Apollo.MutationResult<UpdateProjectMemberMutation>;
 ...
 * });
 */
export function usePostEditorSubscription(
  ...
  return Apollo.useSubscription<
    PostEditorSubscription,
    PostEditorSubscriptionVariables
  >(PostEditorDocument, options);
}
export type PostEditorSubscriptionHookResult = ReturnType<
  typeof usePostEditorSubscription
>;
export type PostEditorSubscriptionResult =
  Apollo.SubscriptionResult<PostEditorSubscription>;
export const CreateSaveDocument = gql`
  mutation CreateSave($input: CreateSaveInput!) {
    createSave(input: $input)
  }
`;
export type CreateSaveMutationFn = Apollo.MutationFunction<
  CreateSaveMutation,
...
export function useCreateSaveMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<CreateSaveMutation, CreateSaveMutationVariables>(
    CreateSaveDocument,
    options
  );
}
export type CreateSaveMutationHookResult = ReturnType<
  typeof useCreateSaveMutation
>;
export type CreateSaveMutationResult =
  Apollo.MutationResult<CreateSaveMutation>;
export type CreateSaveMutationOptions = Apollo.BaseMutationOptions<
  CreateSaveMutation,
  CreateSaveMutationVariables
>;
 ...
 * });
 */
export function useGetSaveQuery(
  baseOptions: Apollo.QueryHookOptions<GetSaveQuery, GetSaveQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetSaveQuery, GetSaveQueryVariables>(
    GetSaveDocument,
    options
  );
}
export function useGetSaveLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetSaveQuery, GetSaveQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetSaveQuery, GetSaveQueryVariables>(
    GetSaveDocument,
    options
  );
}
export function useGetSaveSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    GetSaveQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<GetSaveQuery, GetSaveQueryVariables>(
    GetSaveDocument,
    options
  );
}
...
export type GetSaveSuspenseQueryHookResult = ReturnType<
  typeof useGetSaveSuspenseQuery
>;
export type GetSaveQueryResult = Apollo.QueryResult<
  GetSaveQuery,
  GetSaveQueryVariables
>;
